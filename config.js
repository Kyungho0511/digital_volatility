...
const config = {
  ...
  chapters: [
    ...
    },
    {
      ...
      alignment: "right",
      onChapterEnter: [{ layer: "streets_reviews_2016", opacity: 0.65 }],
      onChapterExit: [{ layer: "streets_reviews_2016", opacity: 0 }],
    },
    {
      id: "gentrification",
      ...
      alignment: "right",
      onChapterEnter: [{ layer: "priceData_2020", opacity: 0.7 }],
      onChapterExit: [{ layer: "priceData_2020", opacity: 0 }],
    },
    {
      id: "haebang-chon",
      ...
      alignment: "right",
      onChapterEnter: [{ layer: "streets_reviews_2020", opacity: 0.7 }],
      onChapterExit: [{ layer: "streets_reviews_2020", opacity: 0 }],
    },
    {
      id: "forecast_streets",
      title: "2023 | analyze popularity of alleyways",
      image: "images/correlations.gif",
      description: `Land prices and Google Trends show a positive correlation coefficient, albeit somewhat weak. Conversely, proximity to subways and attractions exhibits a negative correlation coefficient, indicating that people tend to avoid starting small businesses too close to these urban features. Using datasets from Gyeonlidan-gil, I attempted to predict the future popularity of streets. Streets with higher scores are anticipated to be more popular in the near future.
          <div id="legend_price" class="legend">
